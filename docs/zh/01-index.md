...
2025年7月，TDengine 团队推出新产品 TDengine IDMP — AI 原生的工业数据管理平台。利用 AI 大模型，它可以基于采集的数据，自动感知应用场景、自动生成面板、报表，自动进行实时数据分析。如果你有数据挖掘的需求或者面临海量数据业务洞察的难题，建议详细了解  [TDengine IDMP 并免费试用](https://www.taosdata.com/idmp) 。
